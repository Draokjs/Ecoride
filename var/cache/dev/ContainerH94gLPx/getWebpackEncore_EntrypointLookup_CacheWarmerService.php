...
class getWebpackEncore_EntrypointLookup_CacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->privates['webpack_encore.entrypoint_lookup.cache_warmer'] = new \Symfony\WebpackEncoreBundle\CacheWarmer\EntrypointCacheWarmer(['_default' => 'C:\\Ecoride_symfony/public/build/entrypoints.json'], ($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container)), ($container->targetDir.''.'/webpack_encore.cache.php'));
    }
}
