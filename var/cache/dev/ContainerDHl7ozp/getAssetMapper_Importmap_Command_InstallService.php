...
class getAssetMapper_Importmap_Command_InstallService extends App_KernelDevDebugContainer
{
    ...
    {
        $container->privates['asset_mapper.importmap.command.install'] = $instance = new \Symfony\Component\AssetMapper\Command\ImportMapInstallCommand(($container->privates['asset_mapper.importmap.remote_package_downloader'] ?? $container->load('getAssetMapper_Importmap_RemotePackageDownloaderService')), 'C:\\Ecoride_symfony');
