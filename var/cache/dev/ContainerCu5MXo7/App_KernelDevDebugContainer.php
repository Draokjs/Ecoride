...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\MonEspaceController' => 'getMonEspaceControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NOpI6rk2Sz', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P+BPFac8Jp', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HYlBSdK+VY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5CwRCr7AIE', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3i8CpI+-SJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\ContactController', 'App\\Controller\\HomeController', 'App\\Controller\\LoginController', 'App\\Controller\\MonEspaceController', 'App\\Controller\\RegisterController', 'App\\Controller\\SearchController', 'App\\Controller\\TripController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'C:\\Ecoride_symfony/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('C:\\Ecoride_symfony/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['C:\\Ecoride_symfony\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'C:\\Ecoride_symfony\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => ''], 'C:\\Ecoride_symfony', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    protected static function getAssets_PackagesService($container)
    {
        ...
        return $container->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\AssetMapper\MapperAwareAssetPackage(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy('C:\\Ecoride_symfony/public/build/manifest.json', ($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container)), false), new \Symfony\Component\Asset\Context\RequestStackContext(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $a->getBaseUrl(), $a->isSecure())), ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PXtztXqvCx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MH2-CgSBbP', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sRLynjbAMz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ij+hX4kfMp', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7hY-Iq+Fev', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-VoRnqA71i', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\Ecoride_symfony', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\\Ecoride_symfony\\src\\Entity'], true)), 'App\\Entity');
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['C:\\Ecoride_symfony\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'C:\\Ecoride_symfony\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'C:\\Ecoride_symfony\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['C:\\Ecoride_symfony\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'C:\\Ecoride_symfony\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'C:\\Ecoride_symfony\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => ['C:\\Ecoride_symfony\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'C:\\
\\doctrine\\doctrine-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\twig-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\stimulus-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\ux-turbo/translations', 'C:\\Ecoride_symfony\\vendor\\twig\\extra-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\security-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\monolog-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\debug-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\maker-bundle/translations', 'C:\\Ecoride_symfony\\vendor\\symfony\\webpack-encore-bundle\\src/translations', 'C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-fixtures-bundle/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\Ecoride_symfony');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $a->addPath('C:\\Ecoride_symfony/templates');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\Ecoride_symfony\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension($h, 'C:\\Ecoride_symfony', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['C:\\Ecoride_symfony\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'C:\\Ecoride_symfony',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'WebpackEncoreBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\symfony\\webpack-encore-bundle\\src',
                    'namespace' => 'Symfony\\WebpackEncoreBundle',
                ],
                'DoctrineFixturesBundle' => [
                    'path' => 'C:\\Ecoride_symfony\\vendor\\doctrine\\doctrine-fixtures-bundle',
            ...
            'translator.default_path' => 'C:\\Ecoride_symfony/translations',
            ...
            'twig.default_path' => 'C:\\Ecoride_symfony/templates',
